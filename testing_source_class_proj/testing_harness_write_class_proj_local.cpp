...
//-------------------------------------------------------------------------------------------------------------------------------------------    
    ...
    rc = create_and_activate_run(temp_run, rank_to_dims_funct_name, rank_to_dims_funct_path, 
    ...
    rc = create_and_activate_types(run_id, num_types, num_run_timestep_types);
    if (rc != RC_OK) {
        goto cleanup;
    }
