...
int main(int argc, char **argv) {
	...
	for(int i=0; i<clusters.size(); i++) {
		...
		if (run_type == "remote") {
				// int n = sprintf(output_dir, "PATH_TO_EMPRESS/runtime/runtime_cluster_a/run_build");
			int n = sprintf(output_dir, "FILL_IN_WITH_DESIRED_VALUE"); 
			results_path = "PATH_TO_EMPRESS/testing_source_hdf5/analysis_code/analysis_hdf5";
		}
		...
		debug_log << "output_dir: " << output_dir << endl;
		debug_log << "results_path: " << results_path << endl;
