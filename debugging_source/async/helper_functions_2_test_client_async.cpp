...
int catalog_all_types ( md_server server, md_catalog_var_entry var, uint64_t var_id,
    ...
    fut = metadata_catalog_all_types_with_var_attributes_async (server, var.run_id, var.txn_id);
    ...
    fut = metadata_catalog_all_types_with_var_attributes_with_var_async (server, var.run_id, var_id, var.txn_id);
    getAsyncReturnedValue(fut, type_entries, count, rc);
    if (rc == RC_OK) {
    ...
    fut = metadata_catalog_all_types_with_var_attributes_with_var_in_timestep_async (server, var.run_id, var.timestep_id, var_id, var.txn_id);
    getAsyncReturnedValue(fut, type_entries, count, rc);
    if (rc == RC_OK) {
    ...
    fut = metadata_catalog_all_types_with_var_attributes_with_var_dims_async (server, var.run_id, var_id, var.txn_id, num_dims, vect_dims);
    getAsyncReturnedValue(fut, type_entries, count, rc);
    if (rc == RC_OK) {
    ...
    fut = metadata_catalog_all_types_with_var_attributes_with_var_dims_in_timestep_async (server, var.run_id, var.timestep_id, var_id, var.txn_id, num_dims, vect_dims);
    getAsyncReturnedValue(fut, type_entries, count, rc);
    if (rc == RC_OK) {
...
int catalog_all_timesteps ( md_server server, md_catalog_var_entry var, uint64_t var_id, uint64_t type_id,
    ...
    fut = metadata_catalog_all_timesteps_with_var_async (server, var.run_id, var_id, var.txn_id);
    ...
    fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_async (server, var.run_id, type_id, var_id, var.txn_id);
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_range_async (server, var.run_id, type_id, var_id, var.txn_id, 
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_above_max_async (server, var.run_id, type_id, var_id, var.txn_id, 
...
//     getAsyncReturnedValue(fut, timestep_entries, count, rc);
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_below_min_async (server, var.run_id, type_id, var_id, var.txn_id, 
...
//     getAsyncReturnedValue(fut, timestep_entries, count, rc);
    ...
    fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_dims_async (server, var.run_id, type_id, var_id, var.txn_id, num_dims, vect_dims);
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_dims_range_async (server, var.run_id, type_id, var_id, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data0);
    //getAsyncReturnedValue(fut, timestep_entries, count, rc); 
    //if (rc == RC_OK) {
    //     testing_log << "using metadata_catalog_all_timesteps_with_var_attributes_with_type_var_dims funct: timesteps associated with run_id " << var.run_id << ", type_id " << type_id << 
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_dims_above_max_async (server, var.run_id, type_id, var_id, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data1);
...
//     getAsyncReturnedValue(fut, timestep_entries, count, rc);
    ...
    // fut = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_dims_below_min_async (server, var.run_id, type_id, var_id, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data2);
...
int catalog_all_timestep_attributes ( md_server server, uint64_t run_id, uint64_t timestep_id, uint64_t type_id, uint64_t txn_id) {
    ...
    fut = metadata_catalog_all_timestep_attributes_with_type_async (server, run_id, type_id, txn_id);
    getAsyncReturnedValue(fut, attr_entries, count, rc);
    if (rc == RC_OK) {
    ...
    fut = metadata_catalog_all_timestep_attributes_with_type_in_timestep_async (server, run_id, timestep_id, type_id, txn_id);
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_tyange_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data);
    //getAsyncReturnedValue(fut, attr_entries, count, rc); 
    //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_type_range_in_timestep_async (server, run_id, timestep_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_type_above_max_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data1);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_type_above_max_in_timestep_async (server, run_id, timestep_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data1);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_type_below_min_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data2);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_timestep_attributes_with_type_below_min_in_timestep_async (server, run_id, timestep_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data2);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
...
int catalog_all_run_attributes ( md_server server, uint64_t run_id, uint64_t type_id, uint64_t txn_id) {
    ...
    fut = metadata_catalog_all_run_attributes_with_type_async (server, type_id, txn_id);
    getAsyncReturnedValue(fut, attr_entries, count, rc);
    if (rc == RC_OK) {
    ...
    fut = metadata_catalog_all_run_attributes_with_type_in_run_async (server, run_id, type_id, txn_id);
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_ra(server, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data);
    //getAsyncReturnedValue(fut, attr_entries, count, rc); 
    //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_range_in_run_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data);
...
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_above_max_async (server, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data1);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_above_max_in_run_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data1);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_below_min_async (server, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data2);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
    ...
    // fut = metadata_catalog_all_run_attributes_with_type_below_min_in_run_async (server, run_id, type_id, txn_id, ATTR_DATA_TYPE_BLOB, range_data2);
//     getAsyncReturnedValue(fut, attr_entries, count, rc);
        //if (rc == RC_OK) {
                    ...
                    uint64_t type0_id, uint64_t type1_id )   
{
    ...
    if(insert_run_attrs_in_batch) {
	    ...
	    fut = metadata_insert_run_attribute_batch_async (server, all_run_attrs);
	    ...
	    fut = metadata_insert_run_attribute_async (server, new_attr);
        getAsyncReturnedValue(fut, attribute5_id, rc);
	    if (rc != RC_OK) {
...
int create_timestep_attrs(md_server server, uint64_t timestep_id, uint64_t timestep_id2, uint64_t txn_id,
                    uint64_t type0_id, uint64_t type1_id )   
{
    int rc;
    future<string> fut;
    ...
    if(insert_timestep_attrs_in_batch) {
    	...
    	fut = metadata_insert_timestep_attribute_batch_async (server, all_timestep_attrs);
        getAsyncReturnedValue(fut, rc);
	    if (rc != RC_OK) {
                    ...
                    int64_t type_id, uint64_t var_id, uint64_t txn_id) 
{
    ...
    fut = metadata_create_timestep_async (server, timestep_id+10, run_id, new_timestep_path, txn_id);
        getAsyncReturnedValue(fut, rc);
    if (rc != RC_OK) {
    ...
    // fut = metadata_create_timestep_async (server, timestep_id+20, run_id, new_timestep_path, txn_id);
    // if (rc != RC_OK) {
    //     error_log << "Error. Was unable to create the first new timestep. Exiting \n";
    //     return RC_ERR;
    // }
    ...
    fut = metadata_create_timestep_async (server, timestep_id+30, run_id, new_timestep_path, txn_id);
    getAsyncReturnedValue(fut, rc);
    if (rc != RC_OK) {
        error_log << "Error. Was unable to create the first new timestep. Exiting \n";
        return RC_ERR;
    ...
    fut = metadata_create_timestep_async (server, timestep_id+40, run_id, new_timestep_path, txn_id);
    getAsyncReturnedValue(fut, rc);
    if (rc != RC_OK) {
        error_log << "Error. Was unable to create the first new timestep. Exiting \n";
        return RC_ERR;
    ...
    fut = metadata_create_timestep_async (server, timestep_id+10, run_id2, new_timestep_path, txn_id);
    getAsyncReturnedValue(fut, rc);
    if (rc != RC_OK) {
    ...
    fut = metadata_create_timestep_async (server, timestep_id2+100, run_id, new_timestep_path, txn_id+100);
    getAsyncReturnedValue(fut, rc);
    if (rc != RC_OK) {
