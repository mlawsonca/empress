#include <my_metadata_client_sqlite_transactions_only.hh>
...
int catalog_all_var_attributes_with_type_var_substr ( md_server server, md_catalog_type_entry type, md_catalog_var_entry var,
    ...
    rc = metadata_catalog_all_var_attributes_with_type_var_substr (server, var.run_id, var.timestep_id, type_id, full_var_name_substr, var.txn_id, count, attr_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_var_attributes_with_type_var_substr (server, var.run_id, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, count, attr_entries);
    if (rc == RC_OK) {
        testing_log << "using metadata_catalog_all_var_attributes_with_type_var_substr: var attrs associated with run_id " << var.run_id << ", timestep_id " << 
            var.timestep_id << " and txn_id: " << var.txn_id << " and type_id " << type_id <<
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_range (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_range (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data, count, attr_entries);
    // if (rc == RC_OK) {
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_above_max (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_above_max (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data_new, count, attr_entries);
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_below_min (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_below_min (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data2, count, attr_entries);
    ...
    rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims (server, var.run_id, var.timestep_id, type_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_range (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_range (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     num_dims, vect_dims, ATTR_DATA_TYPE_BLOB, range_data, count, attr_entries);
    // if (rc == RC_OK) {
    //     testing_log << "using metadata_catalog_all_var_attributes_with_type_var_substr_dims_range funct: attributes associated with run_id " << var.run_id << ", timestep_id " << 
    //     var.timestep_id << " and txn_id: " << var.txn_id << " and type_id " << type_id <<
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_above_max (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_above_max (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     num_dims, vect_dims, ATTR_DATA_TYPE_BLOB, range_data_new, count, attr_entries);
    // if (rc == RC_OK) {
    //     testing_log << "using metadata_catalog_all_var_attributes_with_type_var_substr_dims_above_max funct: attributes associated with run_id " << var.run_id << ", timestep_id " << 
    //     var.timestep_id << " and txn_id: " << var.txn_id << " and type_id " << type_id <<
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_below_min (server, var.timestep_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_var_attributes_with_type_var_substr_dims_below_min (server, var.timestep_id, type_id, partial_var_name_substr, var.txn_id, 
    //     num_dims, vect_dims, ATTR_DATA_TYPE_BLOB, range_data2, count, attr_entries);
    // if (rc == RC_OK) {
    //     testing_log << "using metadata_catalog_all_var_attributes_with_type_var_substr_dims_below_min funct: attributes associated with run_id " << var.run_id << ", timestep_id " << 
    //     var.timestep_id << " and txn_id: " << var.txn_id << " and type_id " << type_id <<
...
int catalog_all_var_attributes_with_var_substr ( md_server server, md_catalog_var_entry var, int num_dims, vector<md_dim_bounds> vect_dims ) {
    ...
    rc = metadata_catalog_var (server, var.run_id, var.timestep_id, var.txn_id, count, var_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_var_attributes (server, var.run_id, var.timestep_id, var.txn_id, count, attr_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_var_attributes_with_var_substr (server, var.run_id, var.timestep_id, partial_var_name_substr, var.txn_id, count, attr_entries);
    ...
    rc = metadata_catalog_all_var_attributes_with_var_substr (server, var.run_id, var.timestep_id, full_var_name_substr, var.txn_id, count, attr_entries);
    ...
    rc = metadata_catalog_all_var_attributes_with_var_substr_dims (server, var.run_id, var.timestep_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, count, attr_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_var_attributes_with_var_substr_dims (server, var.run_id, var.timestep_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, count, attr_entries);
    if (rc == RC_OK) {
        testing_log << "using metadata_catalog_all_var_attributes_with_var_substr_dims: var attrs associated with run_id " << var.run_id << ", timestep_id " << var.timestep_id << 
...
int catalog_all_types_substr ( md_server server, md_catalog_var_entry var, 
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr (server, var.run_id, full_var_name_substr, var.txn_id, count, type_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_in_timestep (server, var.run_id, var.timestep_id, full_var_name_substr, var.txn_id, count, type_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr (server, var.run_id, partial_var_name_substr, var.txn_id, count, type_entries);
    if (rc == RC_OK) {
        testing_log << "using metadata_catalog_all_types_with_var_attributes_with_var_substr: types associated with run_id " << var.run_id << 
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_in_timestep (server, var.run_id, var.timestep_id, partial_var_name_substr, var.txn_id, count, type_entries);
    if (rc == RC_OK) {
        testing_log << "using metadata_catalog_all_types_with_var_attributes_with_var_substr_in_timestep: types associated with run_id " << var.run_id << 
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_dims (server, var.run_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, count, type_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_dims_in_timestep (server, var.run_id, var.timestep_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, count, type_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_dims (server, var.run_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, count, type_entries);
    if (rc == RC_OK) {
       testing_log << "using metadata_catalog_all_types_with_var_attributes_with_var_substr_dims: types associated with run_id " << 
            var.run_id << 
    ...
    rc = metadata_catalog_all_types_with_var_attributes_with_var_substr_dims_in_timestep (server, var.run_id, var.timestep_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, count, type_entries);
    if (rc == RC_OK) {
       testing_log << "using metadata_catalog_all_types_with_var_attributes_with_var_substr_dims_in_timestep: types associated with run_id " << 
            var.run_id << ", timestep_id " << var.timestep_id << 
            " and var_name_substr " << partial_var_name_substr << " and txn_id: " << var.txn_id << " overlapping with dims";
...
int catalog_all_timesteps_substr ( md_server server, md_catalog_var_entry var, uint64_t type_id,
    ...
    rc = metadata_catalog_all_timesteps_with_var_substr (server, var.run_id, full_var_name_substr, var.txn_id, count, timestep_entries);
    ...
    rc = metadata_catalog_all_timesteps_with_var_substr (server, var.run_id, partial_var_name_substr, var.txn_id, count, timestep_entries);
    ...
    rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr (server, var.run_id, type_id, full_var_name_substr, var.txn_id, count, timestep_entries);
    ...
    rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_range (server, var.run_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_range (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data0, count, timestep_entries);
    // if (rc == RC_OK) {
    //     testing_log << "using metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_range funct: timesteps associated with run_id " << var.run_id << ", type_id " << type_id << 
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_above_max (server, var.run_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_above_max (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data1, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_below_min (server, var.run_id, type_id, full_var_name_substr, var.txn_id, 
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_below_min (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, 
    //     ATTR_DATA_TYPE_BLOB, range_data2, count, timestep_entries);
    ...
    rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims (server, var.run_id, type_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, count, timestep_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, count, timestep_entries);
    if (rc == RC_OK) {
        testing_log << "using metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims funct: timesteps associated with run_id " << var.run_id << ", type_id " << type_id << 
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_range (server, var.run_id, type_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data0, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_range (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data0, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_above_max (server, var.run_id, type_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data1, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_above_max (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data1, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_below_min (server, var.run_id, type_id, full_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data2, count, timestep_entries);
    ...
    // rc = metadata_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_below_min (server, var.run_id, type_id, partial_var_name_substr, var.txn_id, num_dims, vect_dims, 
    //     ATTR_DATA_TYPE_BLOB, range_data2, count, timestep_entries);
...
int delete_var_substr (md_server server, uint64_t run_id, uint64_t timestep_id, uint64_t txn_id) {
    ...
    rc = metadata_catalog_all_var_attributes (server, run_id, timestep_id, txn_id, count, attr_entries);
    if (rc == RC_OK) {
    ...
    rc = metadata_delete_all_vars_with_substr ( server, run_id, timestep_id, var_name_substr, txn_id);
