...
OpCatalogAllVarAttributesWithVarSubstrDimsMeta::OpCatalogAllVarAttributesWithVarSubstrDimsMeta(opbox::net::peer_ptr_t dst, const md_catalog_all_var_attributes_with_var_substr_dims_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCatalogAllVarAttributesWithVarSubstrDimsMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
