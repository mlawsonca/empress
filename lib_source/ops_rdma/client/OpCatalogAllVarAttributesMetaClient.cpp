...
OpCatalogAllVarAttributesMeta::OpCatalogAllVarAttributesMeta(opbox::net::peer_ptr_t dst, const md_catalog_all_var_attributes_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCatalogAllVarAttributesMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
