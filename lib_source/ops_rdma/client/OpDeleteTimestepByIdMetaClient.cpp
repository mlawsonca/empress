...
OpDeleteTimestepByIdMeta::OpDeleteTimestepByIdMeta(opbox::net::peer_ptr_t dst, const md_delete_timestep_by_id_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpDeleteTimestepByIdMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
