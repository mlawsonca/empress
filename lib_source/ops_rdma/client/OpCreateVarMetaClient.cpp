...
OpCreateVarMeta::OpCreateVarMeta(opbox::net::peer_ptr_t dst, const md_create_var_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCreateVarMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
