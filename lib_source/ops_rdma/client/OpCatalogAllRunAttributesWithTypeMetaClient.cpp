...
OpCatalogAllRunAttributesWithTypeMeta::OpCatalogAllRunAttributesWithTypeMeta(opbox::net::peer_ptr_t dst, const md_catalog_all_run_attributes_with_type_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCatalogAllRunAttributesWithTypeMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
