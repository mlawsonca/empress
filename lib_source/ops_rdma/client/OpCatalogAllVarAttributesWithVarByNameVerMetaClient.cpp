...
OpCatalogAllVarAttributesWithVarByNameVerMeta::OpCatalogAllVarAttributesWithVarByNameVerMeta(opbox::net::peer_ptr_t dst, const md_catalog_all_var_attributes_with_var_by_name_ver_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCatalogAllVarAttributesWithVarByNameVerMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
