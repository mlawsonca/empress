...
OpDeleteRunByIdMeta::OpDeleteRunByIdMeta(opbox::net::peer_ptr_t dst, const md_delete_run_by_id_args &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpDeleteRunByIdMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
