...
OpCreateVarBatchMeta::OpCreateVarBatchMeta(opbox::net::peer_ptr_t dst, const vector<md_create_var_args> &args) 
    : OpCore(true) {
    peer = dst;
...
WaitingType OpCreateVarBatchMeta::handleMessage(bool placeholder, message_t *incoming_msg) {
