...
int catalog_all_metadata_for_run (int rank, uint32_t num_client_procs, uint64_t run_id, 
...
int catalog_types_in_timestep_functs ( int rank, uint32_t num_client_procs,
...
int catalog_run_attributes_with_type_or_val_functs ( int rank, uint32_t num_client_procs,
							uint64_t run_id, uint64_t type_id, uint64_t txn_id,
                            double min_range, double max_range, double above_max_val, double below_min_val
                            );

int catalog_timestep_attributes_with_type_or_val_functs ( int rank, uint32_t num_client_procs,
							uint64_t run_id, uint64_t timestep_id, uint64_t type_id, uint64_t txn_id,
                            double min_range, double max_range, double above_max_val, double below_min_val
							);

int catalog_all_var_attributes_with_dims ( int rank, uint32_t num_client_procs,
...
int catalog_var_attributes_with_var_functs ( int rank, uint32_t num_client_procs,
								const md_catalog_run_entry &run, const md_catalog_var_entry &var, 
								int num_dims, const std::vector<md_dim_bounds> &dims_to_search,
								const std::vector<md_dim_bounds> &proc_dims, uint64_t txn_id 
								);

int catalog_var_attributes_with_type_functs ( int rank, uint32_t num_client_procs,
										const md_catalog_run_entry &run, const std::vector<md_catalog_var_entry> &vars,
...
int catalog_var_attributes_with_type_dims_functs ( int rank, uint32_t num_client_procs,
												const md_catalog_run_entry &run, const std::vector<md_catalog_var_entry> &vars,
...
int catalog_var_attributes_with_type_var ( int rank, uint32_t num_client_procs,
										const md_catalog_run_entry &run, 
										const md_catalog_type_entry &type, const md_catalog_var_entry &var,
                                        uint64_t txn_id, const std::vector<md_dim_bounds> &proc_dims
                                        );

int catalog_var_attributes_with_type_var_or_val_functs ( int rank, uint32_t num_client_procs,
...
int catalog_types_with_var_substr_in_timestep_functs ( int rank, uint32_t num_client_procs,
					uint64_t run_id, uint64_t timestep_id, const std::string &var_substr,
                    int num_dims, const std::vector<md_dim_bounds> &dims_to_search, uint64_t txn_id 
                    );


int catalog_timesteps_with_var_substr_or_val_functs ( int rank, uint32_t num_client_procs,
...
int catalog_var_attributes_with_var_name_substr_functs ( int rank, uint32_t num_client_procs,
											const md_catalog_run_entry &run, const std::vector<md_catalog_var_entry> &vars,
											uint64_t run_id, uint64_t timestep_id,
...
int catalog_var_attributes_with_type_var_name_substr_or_val_functs ( int rank, uint32_t num_client_procs,
													const md_catalog_run_entry &run, const std::vector<md_catalog_var_entry> &vars,
													uint64_t run_id, uint64_t timestep_id,
