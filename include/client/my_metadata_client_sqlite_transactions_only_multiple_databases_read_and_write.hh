...
#ifndef MY_METADATA_CLIENT_SQLITE_TRANSACTIONS_ONLY_MULTIPLE_DATABASES_READ_AND_WRITE
#define MY_METADATA_CLIENT_SQLITE_TRANSACTIONS_ONLY_MULTIPLE_DATABASES_READ_AND_WRITE
