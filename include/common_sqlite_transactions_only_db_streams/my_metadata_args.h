...
#ifndef MD_SERVER_TRANSACTION_SAVEPOINTS
#define MD_SERVER_TRANSACTION_SAVEPOINTS
enum md_server_transaction_savepoints : unsigned short
{
    RUN_TRANSACTION_STARTED = 0,
    TYPE_TRANSACTION_STARTED = 1,
    TIMESTEP_TRANSACTION_STARTED = 2,
    VAR_TRANSACTION_STARTED = 3,
    RUN_ATTR_TRANSACTION_STARTED = 4,
    TIMESTEP_ATTR_TRANSACTION_STARTED = 5,
    VAR_ATTR_TRANSACTION_STARTED = 6,  
};
#endif //MD_SERVER_TRANSACTION_SAVEPOINTS

#ifndef MD_QUERY_TYPE
#define MD_QUERY_TYPE
enum md_query_type : unsigned short
{
    COMMITTED = 0,
    UNCOMMITTED = 1,
    COMMITTED_AND_UNCOMMITTED = 2
};
#endif //MD_QUERY_TYPE
