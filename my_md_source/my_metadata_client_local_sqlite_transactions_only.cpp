...
#include <server_local_sqlite_transactions_only.hh>
#include <sqlite3.h>
...
extern void add_timing_point(int catg);
extern void print_var_attr_data(md_catalog_var_attribute_entry attr);
extern void print_timestep_attr_data(md_catalog_timestep_attribute_entry attr);
extern void print_run_attr_data(md_catalog_run_attribute_entry attr);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...

sqlite3 * get_database(uint64_t job_id) {
    return db;
}
                                        ...
                                        )
{
    ...
    entries.clear();
    return_value = md_catalog_all_run_attributes_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_run_attributes_with_type_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timestep_attributes_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timestep_attributes_with_type_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_dims_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_types_with_var_attributes_with_var_dims_in_timestep_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.var_id = var_id;
    entries.clear();
    return_value = md_catalog_all_types_with_var_attributes_with_var_in_timestep_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_var_attributes_stub (db, args, entries, count);
...
int metadata_catalog_all_var_attributes_with_dims (uint64_t run_id             
    ...
    // }
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_dims_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_by_id_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_by_name_ver_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_dims_by_id_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                       ...
                                       )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_dims_by_name_ver_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    entries.clear();
    args.var_id = var_id;
    return_value = md_catalog_all_var_attributes_with_type_var_by_id_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_var_by_name_ver_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
...
int metadata_catalog_all_var_attributes_with_type_var_dims_by_id (uint64_t timestep_id
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_var_dims_by_id_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_var_dims_by_name_ver_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.var_id = var_id;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_by_id_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.var_version = var_version;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_by_name_ver_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_dims_by_id_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_dims_by_name_ver_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                     ...
                     )
{
    ...
    entries.clear();
    return_value = md_catalog_run_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.run_id = run_id;
    entries.clear();
    return_value = md_catalog_timestep_stub (db, args, entries, count);   
                     ...
                     )
{
    ...
    args.run_id = run_id;
    entries.clear();
    return_value = md_catalog_type_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.timestep_id = timestep_id;
    entries.clear();
    return_value = md_catalog_var_stub (db, args, entries, count);   
                        ...
                        )
{
    ...
    return_value = md_create_run_stub (db, args, run_id);    
                        ...
                        )
{
    ...
    return_value = md_create_timestep_stub (db, args, timestep_id);    
    extreme_debug_log << "about to get future" <<endl;    extreme_debug_log << "about to launch op" <<endl;
                        ...
                        )
{
    ...
    return_value = md_create_type_stub (db, args, type_id);
    extreme_debug_log << "about to get future" <<endl;    extreme_debug_log << "about to launch op" <<endl;
                        ...
                        )
{
    ...
    return_value = md_create_var_stub (db, args, var_id);    
    extreme_debug_log << "about to get future" <<endl;    extreme_debug_log << "about to launch op" <<endl;
                        ...
                        )
{
    ...
    return_value = md_delete_run_by_id_stub (db, args);
                        ...
                        )
{
    ...
    return_value = md_delete_timestep_by_id_stub (db, args);
                        ...
                        )
{
    ...
    return_value = md_delete_type_by_id_stub (db, args);
                        ...
                        )
{
    ...
    return_value = md_delete_type_by_name_ver_stub (db, args);
                        ...
                        )
{
    ...
    return_value = md_delete_var_by_id_stub (db, args);
                        ...
                        )
{
    ...
    return_value = md_delete_var_by_name_path_ver_stub (db, args);
                           ...
                           )
{
    ...
    return_value = md_insert_run_attribute_stub (db, args, attribute_id);
                           ...
                           )
{
    ...
    return_value = md_insert_timestep_attribute_stub (db, args, attribute_id);
                           ...
                           )
{
    ...
    return_value = md_insert_var_attribute_by_dims_stub (db, args, attribute_id);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_run_attributes_with_type_range_stub (db, args, 
    ...
    // return_value = md_catalog_all_run_attributes_with_type_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_dims_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_dims_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_timestep_attributes_with_type_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_timestep_attributes_with_type_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_var_attributes_with_type_var_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_var_attributes_with_type_var_range_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_var_attributes_with_type_var_dims_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_var_attributes_with_type_var_dims_range_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                     ...
                     )
{
    ...
    args.timestep_id = timestep_id;
    entries.clear();
    return_value = md_catalog_all_types_with_var_attributes_in_timestep_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    args.var_name_substr += "%";
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_substr_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    extreme_debug_log << "txn_id is " << to_string(txn_id ) << endl;  
    entries.clear();
    return_value = md_catalog_all_timesteps_with_var_substr_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_types_with_var_attributes_with_var_substr_dims_in_timestep_stub (db, args, entries, count);
                     ...
                     )
{
    ...
    args.var_name_substr += "%";
    entries.clear();
    return_value = md_catalog_all_types_with_var_attributes_with_var_substr_in_timestep_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    args.var_name_substr += "%";
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_var_substr_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_type_var_substr_dims_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    args.dims = dims;
    entries.clear();
    return_value = md_catalog_all_var_attributes_with_var_substr_dims_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                        ...
                        )
{
    ...
    return_value = md_delete_all_vars_with_substr_stub (db, args);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_timesteps_with_var_attributes_with_type_var_substr_dims_range_stub (db, args, entries, count);
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_var_attributes_with_type_var_substr_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_var_attributes_with_type_var_substr_range_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
                                        ...
                                        )
{
    ...
    switch(data_type) {
        case ATTR_DATA_TYPE_INT : {
            ...
            return_value = md_catalog_all_var_attributes_with_type_var_substr_dims_range_stub (db, args, 
                min_int, max_int, entries, count);
    ...
    // return_value = md_catalog_all_var_attributes_with_type_var_substr_dims_range_stub (db, args, entries, count);
    extreme_debug_log << "just launched get attr _by dims \n";
...
int metadata_insert_var_attribute_by_dims_batch (const vector<md_catalog_var_attribute_entry> &new_attributes)
{
    ...
    return_value = md_insert_var_attribute_by_dims_batch_stub (db, all_args);

    // return_value = md_insert_var_attribute_by_dims_batch_stub (db, all_args, ids);
    add_timing_point(MD_INSERT_VAR_ATTRIBUTE_BY_DIMS_BATCH_DONE);   
    // debug_log << "according to the client the attribute_id is " << attribute_id << endl;
    // if(time_pts.size() != catg_of_time_pts.size()) {
    //     debug_log << "error they are off at the end of md insert attributes " << endl;
                        ...
                        )
{
    ...
    // return_value = md_create_type_batch_stub (db, all_args, ids);

    return_value = md_create_type_batch_stub (db, all_args, first_type_id);
    extreme_debug_log << "about to get future" <<endl;    extreme_debug_log << "about to launch op" <<endl;
                        ...
                        )
{
   ...
   //  extreme_debug_log << "args.var_id: " << args.var_id << endl;
    ...
    // return_value = md_create_var_batch_stub (db, all_args, ids);   

    return_value = md_create_var_batch_stub (db, all_args);
                           ...
                           )
{
    ...
    // return_value = md_insert_run_attribute_batch_stub (db, all_args, ids);
    return_value = md_insert_run_attribute_batch_stub (db, all_args);
                           ...
                           )
{
    ...
    // return_value = md_insert_timestep_attribute_batch_stub (db, all_args, ids);
    return_value = md_insert_timestep_attribute_batch_stub (db, all_args);
    add_timing_point(MD_INSERT_TIMESTEP_ATTRIBUTE_BATCH_DONE);   
    // debug_log << "according to the client the attribute_id is " << attribute_id << endl;
    // if(time_pts.size() != catg_of_time_pts.size()) {
    //     debug_log << "error they are off at the end of md insert attributes " << endl;
...
//dummy functions, should never get called
...
{
    error_log << "metadata_activate_run_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_run is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_timestep_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_timestep is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_type is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_var_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_activate_var is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_run_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_run is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_timestep_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_timestep is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_type is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_var_attribute is being called" << endl;
    return RC_ERR;
}
...
{
    error_log << "metadata_processing_var is being called" << endl;
    return RC_ERR;
}
