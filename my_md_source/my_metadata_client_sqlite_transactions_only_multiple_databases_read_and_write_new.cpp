                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_val (server, DATA_RANGE, run_id, timestep_id,   
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_val (server, DATA_MAX, run_id, timestep_id,   
        type_id, var_id, txn_id, data_type, data, count, matching_attributes);
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_val (server, DATA_MIN, run_id, timestep_id,   
        type_id, var_id, txn_id, data_type, data, count, matching_attributes);
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_dims_val (server, DATA_RANGE, run_id, timestep_id, type_id,
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_dims_val (server, DATA_MAX, run_id, timestep_id, type_id,
        var_id, txn_id, num_dims, dims, data_type, data, count, matching_attributes);
    return return_value;
} //end of funct
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_dims_val (server, DATA_MIN, run_id, timestep_id, type_id,
        var_id, txn_id, num_dims, dims, data_type, data, count, matching_attributes);
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_val (server, DATA_RANGE, run_id, timestep_id,   
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_val (server, DATA_MAX, run_id, timestep_id,   
        type_id, var_name_substr, txn_id, data_type, data, count, matching_attributes);
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_val (server, DATA_MIN, run_id, timestep_id,   
        type_id, var_name_substr, txn_id, data_type, data, count, matching_attributes);
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_dims_val (server, DATA_RANGE, run_id, timestep_id, type_id,
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_dims_val (server, DATA_MAX, run_id, timestep_id, type_id,
        var_name_substr, txn_id, num_dims, dims, data_type, data, count, matching_attributes);
    return return_value;
} //end of funct
                                        ...
                                        )
{
    ...
    return_value = metadata_catalog_all_var_attributes_with_type_var_substr_dims_val (server, DATA_MIN, run_id, timestep_id, type_id,
        var_name_substr, txn_id, num_dims, dims, data_type, data, count, matching_attributes);
